# [Chainlink <> Solana Program deployment](https://github.com/smartcontractkit/chainlink-solana-demo)
...
```
git clone https://github.com/smrnjeet222/chainlink-solana
cd chainlink-solana
```
...
```
solana program deploy target/deploy/chainlink_solana.so --keypair solana-wallet/keypair.json
```
