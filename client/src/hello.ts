 ...
 */
const PROGRAM_SO_PATH = path.join(PROGRAM_PATH, 'chainlink_solana.so')
 ...
 */
const PROGRAM_KEYPAIR_PATH = path.join(PROGRAM_PATH, 'chainlink_solana-keypair.json')
